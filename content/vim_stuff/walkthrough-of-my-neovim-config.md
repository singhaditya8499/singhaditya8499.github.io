...
{{< callout  type="info" >}}
You can find the code for my neovim config on my [github](https://github.com/singhaditya8499/nvim).
...
```bash
git clone https://github.com/singhaditya8499/nvim ~/.config/nvim && nvim
