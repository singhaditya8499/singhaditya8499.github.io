...
> The aoc_lib package used in these solutions is my own custom helper functions library. You can find the code [here](https://github.com/singhaditya8499/aoc_lib). I'll try to post my solutions daily. These are probably not the most optimized solutions. That is not my goal with advent of code honestly, I do these just for fun.
...
import (
	...
	aoc_lib "github.com/singhaditya8499/aoc_lib"
)
...
import (
	...
	"github.com/singhaditya8499/aoc_lib"
)
